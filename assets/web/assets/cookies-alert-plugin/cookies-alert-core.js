...
$jscomp.assign = "function" == typeof Object.assign ? Object.assign : function (a, d) {
    for (var c = 1; c < arguments.length; c++) {
        var b = arguments[c];
        if (b)
            for (var e in b) $jscomp.owns(b, e) && (a[e] = b[e])
    }
    return a
};
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.polyfill = function (a, d, c, b) {
    if (d) {
        ...
        b = c[a];
        d = d(b);
        d != b && null != d && $jscomp.defineProperty(c, a, {
            configurable: !0,
            writable: !0,
            value: d
        })
...
$jscomp.polyfill("Array.from", function (a) {
    return a ? a : function (a, c, b) {
        ...
        if ("function" == typeof g) {
            a = g.call(a);
            for (var f = 0; !(g = a.next()).done;) d.push(c.call(b, g.value, f++))
        } else
...
"undefined" !== typeof $ && ($.cookiesDirective = function (a) {
...
function invertHex(a) {
    ...
    return 186 < .299 * d + .587 * c + .114 * a ? "#000000" : "#FFFFFF"
}
var checkConsentAndExecute = function (a) {
        if (getCookie("cookiesDirective")) a.scriptWrapper();
            ...
            a.explicitConsent ? document.getElementById("explicitsubmit").addEventListener("click", function () {
                a.scriptWrapper()
            }) : a.scriptWrapper()
        }
    },
    ...
    checkIE = function () {
        ...
        if ("Microsoft Internet Explorer" == navigator.appName) {
            null !== /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(navigator.userAgent) && (a =
                parseFloat(RegExp.$1));
            if (8 >= a) return !0;
    ...
    disclosure = function (a) {
        ...
        if (a.cookieScripts) {
            ...
            if (1 < b) {
                ...
                d = " We use " + e.substring(0, e.length - 2) + " and " + c[b - 1] + " scripts, which all set cookies. "
            } else d =
                " We use a " + c[0] + " script which sets cookies."
        }
        if (a.customDialogSelector) {
            ...
            if (a.explicitConsent) {
                if (!b.querySelector("#accept")) {
                    ...
                    f.id = "accept";
                    f.style = "display: flex;justify-content: center;align-items: center;margin-bottom:1rem;"
                }
                if (!f) return;
                e.appendChild(f);
                "2" === a.cookiesAlertType && (e = document.createElement("a"), e.id =
                    "explicitreject", e.innerText = a.rejectText || "Reject", e.classList.add("btn"), e.classList.add("btn-white"), e.classList.add("display-7"), e.setAttribute("style", "margin:0 5px;" + (a.rejectColor ? " background-color:" + a.rejectColor + " !important;color:" + invertHex(a.rejectColor) + "!important;" : "") + "border-color:" + a.rejectColor + " !important;border:0px solid; padding:5px 20px; border-radius:2px; cursor: pointer;box-shadow: 0 2px 2px 0 rgb(0 0 0 / 20%);"), f.appendChild(e));
                b.querySelector("a#explicitsubmit") || (b =
                    document.createElement("a"), b.id = "explicitsubmit", b.innerText = a.textButton || "Continue", b.classList.add("btn"), b.classList.add("btn-primary"), b.classList.add("display-7"), b.setAttribute("style", "margin:0 5px;" + (a.colorButton ? " background-color:" + a.colorButton + " !important;color:" + invertHex(a.colorButton) + "!important;" : "") + "border-color:" + a.colorButton + " !important;border:0px solid; padding:5px 20px; border-radius:2px; cursor: pointer;box-shadow: 0 2px 2px 0 rgb(0 0 0 / 20%);"), f.appendChild(b), console.warn('cookiesDirective: Submit button with ID "explicitsubmit" does not exist in custom dialog, so automatically added'))
            } else b.querySelector("a#impliedsubmit") ||
                (f = document.createElement("a"), f.id = "impliedsubmit", f.value = "Do not show this message again", b.appendChild(f), console.warn('cookiesDirective: Submit button with ID "impliedsubmit" does not exist in custom dialog, so automatically added'));
            ...
            c.setAttribute("style", "font-family:sans-serif;position:" + a.css + ";" + a.position + ":-300px;left:0px;width:100%;height:auto;background:" + (a.backgroundColor || "rgb(255,255,255)").replace(/(rgba?)\(([0-9]+),\s+([0-9]+),\s+([0-9]+)(,\s+(\d?\.?\d+))?\)/, "rgba($2,$3,$4," + .01 * (a.bgOpacity || 100) + ")") + ";color:" + a.fontColor + ";text-align:center;z-index:1050;");
            b = document.createElement("div");
            b.classList.add("cookie-wrapper");
            b.setAttribute("style", "position:relative;height:auto;width:90%;padding:10px;margin-left:auto;margin-right:auto;");
            ...
            a.message || (a.explicitConsent ? (a.message = "This site uses cookies. Some of the cookies we ", a.message += "use are essential for parts of the site to operate and have already been set.") :
            ...
            if (a.explicitConsent) {
                ...
                n.setAttribute("style", "display:flex;justify-content:center;align-items:center;margin-bottom:1rem;");
                if ("2" === a.cookiesAlertType) {
                    ...
                    k.setAttribute("style", "margin:0 5px;" + (a.rejectColor ? " background-color:" + a.rejectColor + " !important;color:" + invertHex(a.rejectColor) + "!important;" : "") + "border-color:" + a.rejectColor + " !important;border:0px solid; padding:5px 20px; border-radius:2px; cursor: pointer;box-shadow: 0 2px 2px 0 rgb(0 0 0 / 20%);");
                    n.appendChild(k)
                }
                ...
                k.classList.add("display-7");
                k.setAttribute("style", "margin:0 5px;" + (a.colorButton ? " background-color:" + a.colorButton + " !important;color:" + invertHex(a.colorButton) + "!important;" : "") + "border-color:" + a.colorButton + " !important;border:0px solid; padding:5px 20px; border-radius:2px; cursor: pointer;box-shadow: 0 2px 2px 0 rgb(0 0 0 / 20%);");
                n.appendChild(k);
                e.appendChild(g);
                e.appendChild(n);
                e.appendChild(d);
                b.appendChild(e)
            } else d = document.createTextNode(d), g.appendChild(d), e.appendChild(g), g = document.createElement("div"), g.classList.add("mbr-section-btn"), d = document.createElement("a"), d.setAttribute("style", "margin:0;" + (a.colorButton ? " background-color:" + a.colorButton + " !important;color:" + invertHex(a.colorButton) + "!important;" : "") + (a.colorButton && self === top ? "border-color:" + a.colorButton + " !important;" : "")), d.id = "impliedsubmit", d.setAttribute("class", "btn btn-sm btn-primary display-7"),
                d.appendChild(document.createTextNode(a.textButton)), g.appendChild(d), b.appendChild(e), b.appendChild(g);
            c.appendChild(b);
            f.appendChild(c);
            Array.from(f.querySelectorAll("a")).filter(function (a) {
        ...
        var p = null,
            m = null;
        "top" == l ? (p = {
            top: a.positionOffset
        }, m = {
            top: "-300px"
        }) : (p = {
            bottom: a.positionOffset
        }, m = {
            bottom: "-300px"
        });
        ...
        h.animate(q(h, p), {
            duration: a.animate ? 1E3 : 0
        }).onfinish = function () {
            h.style[l] = p[l];
            if (a.explicitConsent) {
                var b = document.querySelector("#explicitsubmit"),
                    c =
                    document.querySelector("#explicitreject");
                b.addEventListener("click", function () {
                    setCookie("cookiesDirective", 1, 365);
                    a.customDialogSelector ? h.remove() : h.animate(q(h, m), {
                        duration: 1E3
                    }).onfinish = function () {
                        h.style[l] = m[l];
                        h.remove()
                ...
                d.addEventListener("click", function () {
                    d.matches("[demo]") || (setCookie("cookiesDirective", 1, 365),
                        h.animate(q(h, m), {
                            duration: a.animate ? 1E3 : 0
                        }).onfinish = function () {
                            h.style[l] = m[l];
            ...
            0 < a.duration && setTimeout(function () {
                h.animate([{
                    opacity: "1"
                }, {
                    opacity: "0"
